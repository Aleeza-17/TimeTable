...
class Cancelclassescp extends StatefulWidget {
  String myData = ""; // Declare a final variable to store the data

  Cancelclassescp({required this.myData});
  @override
  State<Cancelclassescp> createState() => _CancelclassescpState(myData);
}

class _CancelclassescpState extends State<Cancelclassescp> {
  String mydata1 = "";
  _CancelclassescpState(this.mydata1);
                ...
                child: Center(
                  child: DataTable(
                    ...
                    headingTextStyle: TextStyle(
                      ...
                      color: Colors.blueGrey, // Set light blue color
                    ),
