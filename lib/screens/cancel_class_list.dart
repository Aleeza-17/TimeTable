...
class cancel_class_list extends StatefulWidget {
  cancel_class_list({Key? key}) : super(key: key);

  @override
  State<cancel_class_list> createState() => _cancel_class_listState();
}

class _cancel_class_listState extends State<cancel_class_list> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("List Of Cancel classes"),
      ),
      drawer: Drawermain(),
      body: Container(
