...
class _CoursestState extends State<Coursest> {
  ...
  Future<void> departmentdata() async {
    ...
    setState(() {
      ...
      _selectedfaculty = int.parse(_dept[0][0]);

      print("this is:$_selectedfaculty");
    });
    List<List<dynamic>> data = [];

    if (_selectedfaculty != 0) {
      final results = await conn.query(
          'SELECT Courseid ,Course,creditHour,DepId,FacultyId,Batch,Department FROM course  WHERE FacultyId = $_selectedfaculty');
