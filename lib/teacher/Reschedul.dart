...
import 'package:flutter_application_1/teacher/TeDrawer.dart';
...
class reschedule_class_list extends StatefulWidget {
  ...
  reschedule_class_list({required this.myData});
  @override
  State<reschedule_class_list> createState() =>
      _reschedule_class_listState(myData);
}

class _reschedule_class_listState extends State<reschedule_class_list> {
  String mydata1 = "";
  _reschedule_class_listState(this.mydata1);
  ...
  Future<void> fetchData() async {
    ...
    if (_selectedDept.isEmpty) {
      ...
      final results = await conn.query(
          'SELECT RescheduledId,StartTime,EndTime,Subject,date,Teacher,DepId,Batch,RoomNo FROM reschedule WHERE DepId = $_selectedDept');
          ...
          children: [
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                primary:
                    Colors.blueGrey, // Set the background color to blueGrey
              ),
            ...
            Center(
              child: InkWell(
                ...
                child: Container(
                  ...
                  height: 50,
                  decoration: BoxDecoration(
                    color: Colors.blueGrey, // Update the color to blueGrey
