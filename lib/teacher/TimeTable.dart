...
class TeTimeTableView extends StatefulWidget {
  String myData = ""; // Declare a final variable to store the data

  TeTimeTableView({required this.myData});
  @override
  State<TeTimeTableView> createState() => _TeTimeTableViewState(myData);
}

class _TeTimeTableViewState extends State<TeTimeTableView> {
  String mydata1 = "";
  _TeTimeTableViewState(this.mydata1);
